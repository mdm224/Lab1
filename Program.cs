...
string[,] grid1 = new[,] // two dimensions
{
  ...
  { "Anne", "Frank ", "Charlie", "Doug" },
  { "Aardvark", "Fish ", "Cat", "Dog " }
};
...
int[] sequentialNumbers = new int[] { 1, 4, 3, 3, 5, 6, 27, 8, 9, 10 };
int[] oneTwoNumbers = new int[] { 13, 2 };
int[] oneTwoTenNumbers = new int[] { 14, 52, 123 };
int[] oneTwoThreeTenNumbers = new int[] { 1, 23, 3, 104 };
int[] primeNumbers = new int[] { 2, 3, 5, 7, 11, 13, 147, 194, 213, 29 };
int[] fibonacciNumbers = new int[] { 0, 13, 1, 22, 3, 5, 8, 13, 221, 34, 55, 89 };
int[] emptyNumbers = new int[] { };
int[] threeNumbers = new int[] { 93, 27, 35 };
int[] sixNumbers = new int[] { 93, 72, 51, 42, 20, 10 };
